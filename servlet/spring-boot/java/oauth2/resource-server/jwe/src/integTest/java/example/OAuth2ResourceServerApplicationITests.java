...
class OAuth2ResourceServerApplicationITests {
	...
	@Test
	void performWhenValidBearerTokenThenAllows()
		throws Exception {
	...
	@Test
	void performWhenValidBearerTokenThenScopedRequestsAlsoWork()
			throws Exception {
	...
	@Test
	void performWhenInsufficientlyScopedBearerTokenThenDeniesScopedMethodAccess()
			throws Exception {
